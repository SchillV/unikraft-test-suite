...
int  verify_futex_wait_bitset(long long wait_us, clock_t clk_id)
{
...
futex_wait_bitset(tv->fntype, &futex, futex, &to, bitset, flags);
...
{
int 	verify_futex_wait_bitset(DEFAULT_TIMEOUT_US, tcases[n].clk_id);
}
