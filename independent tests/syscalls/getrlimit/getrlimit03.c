...
int getrlimit_u64(int resource, struct rlimit64 *rlim)
{
...
int getrlimit_ulong(int resource, struct rlimit_ulong *rlim)
{
...
int getrlimit_long(int resource, struct rlimit_long *rlim)
{
	return syscall(__NR_getrlimit, resource, rlim);
}
#endif

int compare_retval(int resource, int ret_u64, int errno_u64,
...
int compare_u64_ulong(int resource, uint64_t val_u64,
...
int compare_u64_long(int resource, uint64_t val_u64, long val_l,
			    const char *kind)
{
...
void run(unsigned int resource)
{
